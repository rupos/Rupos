...
public class BPMNexportUtil {
	...
	public static BPMNDiagram exportPerformancetoBPMN(
	...
	public static BPMNDiagram exportConformancetoBPMN(
			TraslateBPMNResult traslateBpmnresult,
	...
	public static Xpdl exportToXpdl(PluginContext c,Xpdl xpdl, TraslateBPMNResult traslateBpmnresult, BPMNDiagram newbpmn)throws Exception {
	...
	private static Xpdl importXpdlFromStream( InputStream input,
	...
	private static GraphLayoutConnection layoutcreate(PluginContext c, BPMNDiagram net){
	...
	private static void fixParallelTransitions(JGraphFacade facade, double spacing) {
