...
import org.processmining.plugins.xpdl.XpdlExtensions;
...
import org.processmining.plugins.xpdl.collections.XpdlApplications;
...
import org.processmining.plugins.xpdl.collections.XpdlFormalParameters;
...
import org.processmining.plugins.xpdl.collections.XpdlPartnerLinks;
...
public class XpdlProcessType extends XpdlIdName {
	...
	public void convertToBpmn(BPMNDiagram bpmn, Map<String, BPMNNode> id2node) {
		if (activities != null) {
			activities.convertToBpmn(bpmn, null, activitySets, id2node);
		}
		if (transitions != null) {
			transitions.convertToBpmn(bpmn, null, activitySets, id2node);
		}
	}
