...
import org.processmining.plugins.xpdl.XpdlCondition;
...
public class XpdlTransition extends XpdlIdName {
	...
	public void setConnectorGraphicsInfos(
			XpdlConnectorGraphicsInfos connectorGraphicsInfos) {
	...
	public void convertToBpmn(BPMNDiagram bpmn, SubProcess parent, XpdlActivitySets activitySets,
		...
		if ((from != null) && (to != null)) {
			...
			if ((fromNode != null) && (toNode != null)) {
				 bpmn.addFlow(fromNode, toNode, parent);
			}
		}
	}
}
