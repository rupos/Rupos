...
import org.processmining.plugins.xpdl.XpdlDeadline;
import org.processmining.plugins.xpdl.XpdlEvent;
import org.processmining.plugins.xpdl.XpdlIORules;
import org.processmining.plugins.xpdl.XpdlIcon;
import org.processmining.plugins.xpdl.XpdlImplementation;
import org.processmining.plugins.xpdl.XpdlLoop;
import org.processmining.plugins.xpdl.XpdlRoute;
import org.processmining.plugins.xpdl.XpdlSimulationInformation;
import org.processmining.plugins.xpdl.XpdlTransaction;
import org.processmining.plugins.xpdl.collections.XpdlActivitySets;
import org.processmining.plugins.xpdl.collections.XpdlAssignments;
import org.processmining.plugins.xpdl.collections.XpdlDataFields;
import org.processmining.plugins.xpdl.collections.XpdlExtendedAttributes;
import org.processmining.plugins.xpdl.collections.XpdlInputSets;
import org.processmining.plugins.xpdl.collections.XpdlOutputSets;
import org.processmining.plugins.xpdl.collections.XpdlPerformers;
import org.processmining.plugins.xpdl.collections.XpdlTransitionRestrictions;
import org.processmining.plugins.xpdl.deprecated.XpdlFinishMode;
import org.processmining.plugins.xpdl.deprecated.XpdlStartMode;
...
import org.processmining.plugins.xpdl.text.XpdlLimit;
import org.processmining.plugins.xpdl.text.XpdlPerformer;
...
public class XpdlActivity extends XpdlIdName {
	...
	protected void CheckValidity(Xpdl xpdl) {
		...
		checkRestriction(xpdl, "Status", status, Arrays.asList("None", "Ready", "Active", "Cancelled", "Aborting",
				"Aborted", "Completing", "Compelted"), false);
		...
		if (event != null) {
			...
			if (blockActivity != null) {
				...
				id2node.put(id, bpmn.addActivity(name, (loop != null) && loop.hasType("Standard"), false, false,
						(loop != null) && loop.hasType("MultiInstance"), false, parent));
			}
		}
	}
}
