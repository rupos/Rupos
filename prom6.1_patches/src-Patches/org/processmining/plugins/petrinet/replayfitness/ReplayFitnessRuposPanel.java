...
public class ReplayFitnessRuposPanel extends JPanel{
	...
	public ReplayFitnessRuposPanel(PluginContext context, Petrinet net,
			XLog log, Progress progress, TotalFitnessResult tovisualize) {
	...
	private String UItotalResult(TotalFitnessResult result){
