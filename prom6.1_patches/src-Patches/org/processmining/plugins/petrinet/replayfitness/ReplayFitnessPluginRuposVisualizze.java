...
@Visualizer
@Plugin(name = "Fitness Result Visualizer", parameterLabels = "Fitness Rupos Analisys", returnLabels = "Visualized Fitness", returnTypes = JComponent.class)
public class ReplayFitnessPluginRuposVisualizze {
	...
	private void drawfitnessnet(Petrinet net, TotalFitnessResult tovisualize) {
	...
	private JComponent getVisualizationPanel(PluginContext context,
			Petrinet net, XLog log, TotalFitnessResult tovisualize) {
		Progress progress = context.getProgress();

		ReplayFitnessRuposPanel panel = new ReplayFitnessRuposPanel(context, net, log, progress, tovisualize);
		return panel;
